...
function cifrar128(){
    ...
    if(clave.length!=16){
        swal("Favor de usar una clave de 16 caracteres por persona.");
    }else{
...
function cifrar192(){
    ...
    if(clave.length!=24){
        swal("La clave debe contener 24 caracteres por usuario.");
    }else{
        var cifrado = CryptoJS.AES.encrypt(txt, clave);
        document.getElementById("txtcifrado").innerHTML=cifrado;
...
function cifrar256(){
    ...
    if(clave.length!=32){
        swal("La clave tiene que ser 32 caracteres por cada uno");
    }else{
        var cifrado = CryptoJS.AES.encrypt(txt, clave);
        document.getElementById("txtcifrado").innerHTML=cifrado;
